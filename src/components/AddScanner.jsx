...
import { useCreateScannerMutation } from "../redux/features/scanner/scannerApi";
import { useEffect } from "react";
import getCurrentDateTime from "../hooks/getCurrentDateTime";

const AddScanner = () => {
  const navigate = useNavigate();
  const [createScanner, { isLoading, isError, error, isSuccess }] =
  ...
  return (
    <div className="bg-gray-100 w-full ">
      <div className="flex justify-between">
        <h1 className="text-4xl">Add New Scanner</h1>
      </div>
